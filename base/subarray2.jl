...
# Linear indexing
getindex{T,N,P,IV}(V::SubArray{T,N,P,IV,N}, i::Int) = V.parent[V.first_index + V.stride1*(int(i)-1)]
setindex!{T,N,P,IV}(V::SubArray{T,N,P,IV,N}, v, i::Int) = V.parent[V.first_index + V.stride1*(int(i)-1)] = v
